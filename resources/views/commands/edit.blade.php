                                    ...
                                    <div class="col-md-12">
                                        <table id="products" class="table products">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" step="0.01" min="0" class="form-control" id="prix_livraison" value="{{ $command->prix_livraison }}" onchange="calculPrix()"  name="prix_livraison" placeholder="Prix Livraison" required>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   <input type="number" step="0.01" min="0" class="form-control" id="remise" value="{{ $command->remise }}" onchange="calculPrix()" name="remise" placeholder="Remise">
